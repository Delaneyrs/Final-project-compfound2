...
int main() {
    string first_name;
    char position;
    char playAgain = 'L'; // Used to control the "start over" loop
        ...
        if (position == 'L') {
            ...
            if (position == 'L') {
                ...
                if (position == 'L') {
                    ...
                    if (position == 'L') {
                        ...
                        if (position == 'L') {
                            ...
                            if (position == 'L') {
                                ...
                                cout << "Will you run in and stop him (L) or watch in silence (R)?" << endl;
                                cin >> position;

                                if (position == 'L') {
                                    cout << "The second you take a step into the summoning circle you explode into a red vapor." << endl;
                                } else if (position == 'R') {
                                    cout << "As Dapper finishes his chanting you're suddenly teleported outside." << endl;
                                    cout << "You have escaped! Congrats!" << endl;
                                }
                            } else if (position == 'R') {
                                cout << "As you round the bend, you see a large monster with thousands of teeth. Pomme looks up. 'Um that's not Dapper.'" << endl;
                    ...
                    cout << "You try to open the door, but it does not budge. You are there for all of eternity with your new friend." << endl;
                }

            } else if (position == 'R') {
                cout << "As you walk down the hallway, a child with bright blonde hair runs straight into you." << endl;
                cout << "Hi! My name is Chayanne! I'm looking for my sister, her name is Tallulah. Can you help? Yes (L) No (R)" << endl;
                cin >> position;

                if (position == 'L') {
                    cout << "Thank you so much! He grabs your hand and continues sprinting down the hallway." << endl;
                    cout << "She likes music and gardening! I hope she's ok." << endl;
                    cout << "Do you follow the noise (L) or follow the sunlight (R)?" << endl;
                    cin >> position;
            ...
            cout << "Invalid direction. Try again next time!" << endl;
        }
